...
st.set_page_config(layout="wide", page_title="Multiple Disease Prediction System", page_icon="https://www.freeiconspng.com/thumbs/doctor-logo/doctors-medicine-doctor-logo-png-clipart-6.png")
